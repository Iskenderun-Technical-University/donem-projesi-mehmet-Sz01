...
{
    public partial class InsaatFrm : Form
    {
        public InsaatFrm()
        {
            InitializeComponent();
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Tbl_Insaat (DersAdı) values (@p1)", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand Komutsil = new SqlCommand("Delete From Tbl_Insaat Where DersAdı = @k1", baglanti);
