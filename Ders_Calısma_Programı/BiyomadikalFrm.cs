...
namespace Ders_Calısma_Programı
{
    public partial class BiyomedikalFrm : Form
    {
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Tbl_Biyomedikal (DersAdı) values (@p1)", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand Komutsil = new SqlCommand("Delete From Tbl_Biyomedikal Where DersAdı = @k1", baglanti);
