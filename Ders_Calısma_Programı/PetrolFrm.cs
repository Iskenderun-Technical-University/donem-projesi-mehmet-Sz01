...
{
    public partial class PetrolFrm : Form
    {
        public PetrolFrm()
        {
            InitializeComponent();
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Tbl_Petrol (DersAdı) values (@p1)", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand Komutsil = new SqlCommand("Delete From Tbl_Petrol Where DersAdı = @k1", baglanti);
