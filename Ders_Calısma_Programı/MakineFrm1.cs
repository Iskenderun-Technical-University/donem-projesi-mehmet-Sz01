...
{
    public partial class MakineFrm : Form
    {
        public MakineFrm()
        {
            InitializeComponent();
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Tbl_Makine (DersAdı) values (@p1)", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand Komutsil = new SqlCommand("Delete From Tbl_Makine Where DersAdı = @k1", baglanti);
